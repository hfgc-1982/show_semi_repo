"""
Django settings for show_semi project.
...
SECRET_KEY = 'unn8(7+$2+t@bai$h0uhlo0hg(tzj$7kdmrmq-1mjny6t&gl2='
...
WSGI_APPLICATION = 'show_semi.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tv', # nombre de la base de datos, se creará en el servidor de Postgres a continuación
